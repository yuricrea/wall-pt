...
- **IL PIÙ GRAVE:** lo spazio come "eventificio"
...
- Se qualcosa resta sul muro a lungo è perché quella collettiva non comunica (segnale)
...
> "Bisogna imparare Zapier/IFTTT ma se nessuno li sa usare?"

#### La soluzione: Setup Iniziale + Manutenzione Zero

**FASE 1: Hacknight Setup (una volta sola, 4-6 ore)**

- Tu + A-K-M-E + chi vuole partecipare
    
- Configurate tutto in UNA sessione
    
- Documentate passo-passo (guide + screenshot)
...
**Cosa:** Poster A3/A2 da affiggere all'ingresso e nel seminterrato
...
- A-K-M-E (server + WordPress + n8n se vogliamo)
    
- Chi sa HTML/CSS/JS (implementazione wall)
    
- Chi vuole imparare (documentazione + formazione)
...
1.  **Mattina (10-13):**
    ...
    - Installazione tema WP standard + Gutenberg
        
    - Integrazione Wall SpaceTime come blocco custom
        
    - Setup struttura tag (tassonomia + plugin suggerimenti)
        
2.  **Pausa pranzo (13-14):** Pasta
    
3.  **Pomeriggio (14-18):**
    
    - Implementazione Wall Collettive (aggregatore feed RSS)
        
    - Configurazione automazione completa (IFTTT o n8n)
        
    - Test cross-browser (Safari, Firefox, mobile)
        
    - Documentazione passo-passo per manutenzione
        

**Output:**

- Wall SpaceTime integrato in pianoterralab.org
    
- Wall Collettive funzionante (anche se con pochi feed iniziali)
    
- Automazione social completa
    
- Guide manutenzione per collettive
...
- https://www.seventeenagency.com/ (navigazione non-lineare)
    
- http://18.burocratik.com/ (estetica grunge)
    
- https://bbang.it/ (interattività)
    
- https://www.zerowind.it/ (respiro elementi)
...
- A-K-M-E: [https://akme.vado.li](https://akme.vado.li/)
...
- IFTTT: [https://ifttt.com](https://ifttt.com/) (più semplice)
    
- n8n: [https://n8n.io](https://n8n.io/) (self-hosted, etico)
    
- Zapier: [https://zapier.com](https://zapier.com/) (alternativa IFTTT)
    
- Make: [https://make.com](https://make.com/) (ex-Integromat, intermedio)
...
> *"La mancanza di curiosità è deriva verso l'ignoranza e l'oblio  
> delle capacità critiche del presente e del passato, strumenti per  
> comprendere e intercettare flussi spaziotemporali nel futuro  
> senza certezze del mondo di mezzo."*
...
**È anche capacità di prendersi cura degli strumenti comuni.**
...
- Email: \[via Piano Terra mailing list\]   --  yuri@inventati.org
...
**Dati & Analisi:** Export calendario Piano Terra (1110 eventi 2012-2025)  
**Ispirazione:** Le pareti di Piano Terra (13 anni di sticker/locandine/lotte)

**Sviluppato presso Pio Albergo Trivulzio durante ricovero per polmonite acuta.**  
...
*Documento vivo - ultima modifica: 12 dicembre 2025*  
